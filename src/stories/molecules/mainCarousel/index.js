...
const mainCarousel = ({data}) => {
  return (
    <div className="border-1 border-solid border-gray-border rounded-20 px-20 py-12 max-w-285 max-y-193">
      ...
      <p className="text-black-900 text-24 font-extrabold mb-30">{data.accBalance}</p>
